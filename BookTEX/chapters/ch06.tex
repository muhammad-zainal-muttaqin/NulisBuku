...
\subsection{Ekstraksi Komponen Kalender}\label{ekstraksi-komponen-kalender}
...
\subsection{Masalah Jarak pada Waktu Linier}\label{masalah-jarak-pada-waktu-linier}
...
\subsection{Transformasi Siklik dengan Trigonometri}\label{transformasi-siklik-dengan-trigonometri}
...
\subsection{Perbandingan terhadap Baseline}\label{perbandingan-terhadap-baseline}
...
\subsection{Metode Diagnostik Lanjutan}\label{metode-diagnostik-lanjutan}
