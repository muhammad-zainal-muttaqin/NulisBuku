...
\subsection{Ekstensi dan Varian PCA}\label{ekstensi-dan-varian-pca}
...
\subsection{Whitening dan Kompresi Embedding Terlatih}\label{whitening-dan-kompresi-embedding-terlatih}
...
\subsection{\texorpdfstring{Fungsi Kerugian \(\beta\)-divergence}{Fungsi Kerugian \textbackslash beta-divergence}}\label{fungsi-kerugian-beta-divergence}
...
\subsection{Aspek Komputasi dan Skalabilitas}\label{aspek-komputasi-dan-skalabilitas}
...
\subsection{Domain Aplikasi Spesifik}\label{domain-aplikasi-spesifik}
...
\subsection{\texorpdfstring{t-SNE (\emph{t-Distributed Stochastic Neighbor Embedding})}{t-SNE (t-Distributed Stochastic Neighbor Embedding)}}\label{t-sne-t-distributed-stochastic-neighbor-embedding}
...
\subsection{\texorpdfstring{UMAP (\emph{Uniform Manifold Approximation and Projection})}{UMAP (Uniform Manifold Approximation and Projection)}}\label{umap-uniform-manifold-approximation-and-projection}
...
\subsection{Perkembangan Varian Manifold (2019--2026)}\label{perkembangan-varian-manifold-20192026}
...
\subsection{Arsitektur Dasar: Encoder dan Decoder}\label{arsitektur-dasar-encoder-dan-decoder}
...
\subsection{Varian Autoencoder untuk Fitur Laten}\label{varian-autoencoder-untuk-fitur-laten}
...
\subsection{Batasan Kompresi: Hanya Data Lokal}\label{batasan-kompresi-hanya-data-lokal}
...
\subsection{Kesalahan Umum 1: Menggunakan Koordinat Visualisasi sebagai Fitur}\label{kesalahan-umum-1-menggunakan-koordinat-visualisasi-sebagai-fitur}
...
\subsection{Kesalahan Umum 2: Kebocoran Data (Data Leakage)}\label{kesalahan-umum-2-kebocoran-data-data-leakage}
...
\subsection{Batasan Pemrosesan Laten dan Representasi Eksternal (Bab 15)}\label{batasan-pemrosesan-laten-dan-representasi-eksternal-bab-15}
