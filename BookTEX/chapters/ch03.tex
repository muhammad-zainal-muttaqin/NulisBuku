...
\subsection{Dominasi Skala pada Fungsi Objektif}\label{dominasi-skala-pada-fungsi-objektif}
...
\subsection{Distribusi Menceng Melanggar Asumsi Model}\label{distribusi-menceng-melanggar-asumsi-model}
...
\subsection{Standardisasi}\label{standardisasi}
...
\subsection{\texorpdfstring{Skala Min-Max (\emph{Min-Max Scaling})}{Skala Min-Max (Min-Max Scaling)}}\label{skala-min-max-min-max-scaling}
...
\subsection{Kriteria Penggunaan}\label{kriteria-penggunaan}
...
\subsection{Clipping (Winsorization)}\label{clipping-winsorization}
...
\subsection{Discretization (Binning)}\label{discretization-binning}
...
\subsection{Model yang Sensitif terhadap Skala}\label{model-yang-sensitif-terhadap-skala}
...
\subsection{Model yang Tidak Sensitif terhadap Skala}\label{model-yang-tidak-sensitif-terhadap-skala}
