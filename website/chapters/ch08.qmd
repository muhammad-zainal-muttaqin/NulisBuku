...
* **$\beta=2$ (Frobenius norm):** Fungsi standar yang paling umum dipakai dan bekerja baik pada sebaran data numerik berkelanjutan yang tak-negatif.
...
* **Kontrol sparsitas:** Melalui injeksi nilai penalti (L1 maupun L2) terhadap matriks $W$ atau $H$, struktur representasi laten dapat dipaksa untuk lebih renggang (*sparse*), membatasi agar satu dokumen atau sinyal benar-benar dibangun dari sesedikit mungkin fitur penyusun dasar.
