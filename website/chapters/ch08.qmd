...
![Dua tujuan reduksi dimensi](../figures/ch08-fig-1.png){#fig-ch08-fig-1}
...
![Arah utama dan proyeksi PCA](../figures/ch08-fig-2.png){#fig-ch08-fig-2}
...
### Memilih k dan memahami whitening {.pendalaman-title .unnumbered .unlisted}
...
![Dekomposisi NMF pada matriks piksel digit](../figures/ch08-fig-3.png){#fig-ch08-fig-3}
...
### Fungsi kerugian beta-divergence dan praktik NMF {.pendalaman-title .unnumbered .unlisted}
...
![Cara membaca plot t-SNE atau UMAP](../figures/ch08-fig-4.png){#fig-ch08-fig-4}
...
### Inisialisasi, struktur global, dan varian modern {.pendalaman-title .unnumbered .unlisted}
...
![Arsitektur autoencoder untuk representasi laten](../figures/ch08-fig-5.png){#fig-ch08-fig-5}
...
| Metode | Tujuan utama | Transform data baru? | Interpretabilitas | Biayaprasyarat |
| --- | --- | --- | --- | --- |
| PCA SVD | Kompresi, denoising | Ya | Sedang, bobot *loading* menunjukkan kontribusi fitur asal ke komponen | Murah, linear |
| Truncated SVD | Kompresi matriks sparse | Ya | Sedang | Murah, tanpa centering |
| NMF | Bagiantopik aditif | Ya | Tinggi jika komponen bermakna | Input non-negatif, init sensitif |
...
: Peta metode reduksi dimensi {#tbl-ch08-8}
