...
![Skala mentah yang meregangkan ruang fitur](../figures/ch03-fig-1.png)
...
![Dua cara membuat skala fitur lebih sebanding](../figures/ch03-fig-2.png)
...
![\emph{Min-max scaling} dan \emph{robust scaling} ketika ada nilai ekstrem](../figures/ch03-fig-3.png)
...
![Mengubah bentuk distribusi fitur numerik](../figures/ch03-fig-4.png)
...
**Tabel 3.1 --- Aturan penetapan batas untuk *clipping* atau *winsorization***
...
![\emph{Clipping} dan \emph{binning} pada satu sumbu numerik](../figures/ch03-fig-5.png)
...
**Tabel 3.2 --- Peta kepekaan keluarga model terhadap transformasi numerik**
...
![Batas keputusan \emph{k-NN} sebelum dan sesudah standardisasi](../figures/ch03-fig-6.png)
