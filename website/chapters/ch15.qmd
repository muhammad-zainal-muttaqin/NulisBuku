# Representasi yang Dipelajari Mesin dan Pretrained Model
...
## Embedding dan Spektrum Adaptasi
...
![Spektrum adaptasi pretrained encoder](../figures/ch15-fig-1.png){#fig-ch15-fig-1}
...
### LoRA, adaptasi lewat dekomposisi peringkat rendah {.pendalaman-title .unnumbered .unlisted}
...
## Feature Bank dan Similarity Metrics
...
![Feature bank dan pencarian embedding](../figures/ch15-fig-2.png){#fig-ch15-fig-2}
...
## Mengevaluasi Kualitas Embedding dan Risiko Domain Shift
...
![Linear probing untuk menguji embedding](../figures/ch15-fig-3.png){#fig-ch15-fig-3}
...
### *Linear probing*: menguji ruang embedding dengan model sengaja sederhana {.pendalaman-title .unnumbered .unlisted}
...
![Kompresi data sendiri vs transfer representasi](../figures/ch15-fig-4.png){#fig-ch15-fig-4}
...
## Apakah *Deep Learning* Menghapus Rekayasa Fitur?
...
## Input Representation, Tokenization, dan Augmentation
...
## *Deep Learning* pada Data Tabular: Learned Tabular Embeddings
...
: Gradient boosting vs deep tabular {#tbl-ch15-9}
...
### Tabular foundation model dan *in-context learning* {.pendalaman-title .unnumbered .unlisted}
...
## Hybrid Models: Fitur Rekayasa sebagai Input Tambahan
...
![Arsitektur hybrid dua jalur](../figures/ch15-fig-5.png){#fig-ch15-fig-5}
