...
: Ilustrasi semi-sintetis dari baris *invoice* ke satu baris pelanggan-bulan {#tbl-ch01-8}
...
| unit | total_belanja_30h | jumlah_invoice | ragam_produk | hari_sejak_transaksi_terakhir | (target) membeli_lagi_30h |
| --- | --- | --- | --- | --- | --- |
| 17850 @ 2011-01 | 83.14 | 3 | 4 | 5 | ditentukan dari $ [t_p,t_p+30 hari) $ |

: Ilustrasi semi-sintetis dari baris *invoice* ke satu baris pelanggan-bulan (lanjutan) {#tbl-ch01-9}
...
![Posisi rekayasa fitur dalam alur *machine learning*](../figures/ch01-fig-1.png){#fig-ch01-fig-1}
...
| Dimensi | Representasi yang dirancang manusia | Representasi yang dipelajari mesin |
| --- | --- | --- |
...
| Kebutuhan komputasi | Ringan | Berat, terutama untuk pelatihan atau inferensi *encoder* |
...
: Perbandingan representasi yang dirancang manusia dan representasi yang dipelajari mesin {#tbl-ch01-10}
...
![Spektrum representasi yang dirancang manusia sampai dipelajari mesin](../figures/ch01-fig-2.png){#fig-ch01-fig-2}
...
### *Self-supervised learning*, manusia merancang lingkungan belajar {.pendalaman-title .unnumbered .unlisted}
...
### Rekayasa konteks untuk model fondasi {.pendalaman-title .unnumbered .unlisted}
...
![Tabel data untuk model sebagai potongan waktu untuk satu unit](../figures/ch01-fig-3.png){#fig-ch01-fig-3}
...
### *Point-in-time correctness* dan *feature store* {.pendalaman-title .unnumbered .unlisted}
...
![Peta struktur representasi](../figures/ch01-fig-4.png){#fig-ch01-fig-4}
