...
![Kontrak \texttt{fit} dan \texttt{transform} dalam \emph{pipeline}](../figures/ch02-fig-1.png)
...
![Peta jenis-jenis \emph{data leakage}](../figures/ch02-fig-2.png)
...
**Tabel 2.1 --- Memilih strategi pemisahan data**
...
![\emph{Random split}, \emph{group split}, dan \emph{temporal split}](../figures/ch02-fig-3.png)
...
![\emph{Preprocessing} di luar vs di dalam \emph{cross-validation}](../figures/ch02-fig-4.png)
...
**Tabel 2.2 --- Anti-pola umum dan perbaikannya**
