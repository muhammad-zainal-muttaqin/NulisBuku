...
## Rasio, Selisih, dan Fitur Interaksi
...
: Keluarga fitur turunan {#tbl-ch06-8}
...
![Proyeksi polinomial dari ruang asli ke ruang fitur](../figures/ch06-fig-1.png){#fig-ch06-fig-1}
...
## Agregasi dan Fitur Berbasis Grup
...
: Pola jendela agregasi {#tbl-ch06-9}
...
![Pola jendela agregasi pada timeline pelanggan](../figures/ch06-fig-2.png){#fig-ch06-fig-2}
...
### Agregasi berbobot kebaruan {.pendalaman-title .unnumbered .unlisted}
...
## Fitur Relasional dan *Event Log* untuk Join, Agregasi, dan *Point-in-Time Correctness*
...
![Fan-out join dan *as-of join* pada fitur relasional](../figures/ch06-fig-3.png){#fig-ch06-fig-3}
...
## Fitur Tanggal, Waktu, dan Siklus
...
![Encoding siklik untuk jam dalam sehari](../figures/ch06-fig-4.png){#fig-ch06-fig-4}
...
![Pertumbuhan jumlah fitur turunan](../figures/ch06-fig-5.png){#fig-ch06-fig-5}
...
### Mendeteksi redundansi dengan VIF {.pendalaman-title .unnumbered .unlisted}
...
## Memvalidasi Apakah Fitur Baru Membantu
...
### Diagnostik kontribusi fitur melalui ablation, probe, dan atribusi {.pendalaman-title .unnumbered .unlisted}
...
- Feature-engine --- Feature creation --- <https://feature-engine.trainindata.com/en/latest/api_doc/creation/index.html>. MathFeatures, RelativeFeatures, dan CyclicalFeatures.

- scikit-learn --- PolynomialFeatures --- <https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.PolynomialFeatures.html>. Fitur polinomial dan interaksi.

- pandas --- merge_asof --- <https://pandas.pydata.org/docs/reference/api/pandas.merge_asof.html>. As-of join yang menghormati batas waktu.

- Featuretools --- <https://featuretools.alteryx.com/>. Deep Feature Synthesis otomatis dari data relasional.

- tsfresh --- <https://tsfresh.readthedocs.io/>. Ekstraksi fitur deret waktu skala besar.

- statsmodels --- Variance Inflation Factor --- <https://www.statsmodels.org/stable/generated/statsmodels.stats.outliers_influence.variance_inflation_factor.html>. Mendeteksi multikolinearitas antar fitur.

- Kursa & Rudnicki (2010), Boruta (JStatSoft) --- <https://doi.org/10.18637/jss.v036.i11>. Seleksi fitur all-relevant.
