...
![Dari koordinat ke fitur spasial](../figures/ch13-fig-1.png){#fig-ch13-fig-1}
...
![*Spatial lag* dengan beberapa skema bobot tetangga](../figures/ch13-fig-2.png){#fig-ch13-fig-2}
...
### Indikator autokorelasi lokal (LISA) sebagai fitur {.pendalaman-title .unnumbered .unlisted}
...
![Random split, spatial block, dan buffer](../figures/ch13-fig-3.png){#fig-ch13-fig-3}
...
| Ukuran | Mengukur apa | Contoh node yang menonjol |
| --- | --- | --- |
...
| PageRankeigenvector | Terhubung ke node yang juga penting | Anggota yang terhubung ke anggota sentral |
| Clustering coefficient | Kepadatan lokal antar tetangga | Anggota *clique* |

: Ukuran sentralitas dan makna pentingnya {#tbl-ch13-8}
...
### Bias jalan acak dengan parameter p dan q {.pendalaman-title .unnumbered .unlisted}
...
![*Message passing* pada GNN](../figures/ch13-fig-4.png){#fig-ch13-fig-4}
...
| Pendekatan | Memakai atribut node? | Node baru *inductive*? | Biaya | Kapan cukup |
| --- | --- | --- | --- | --- |
...
| node2vecDeepWalk | Umumnya tidak | Terbatas pada graf tetap | Sedang | Topology kuat, atribut minim |
| GNN (GCNGATGraphSAGE) | Ya | Bisa, tergantung desain | Sedang-tinggi | Struktur dan atribut sama-sama penting |

: Tangga representasi graf {#tbl-ch13-9}
...
### Varian dan batas praktis GNN {.pendalaman-title .unnumbered .unlisted}
...
![Graph split dengan dan tanpa edge lintas batas](../figures/ch13-fig-5.png){#fig-ch13-fig-5}
