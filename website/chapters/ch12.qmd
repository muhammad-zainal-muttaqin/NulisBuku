...
![Tensor citra, augmentasi pelatihan, dan preprocessing evaluasi](../figures/ch12-fig-1.png){#fig-ch12-fig-1}
...
### Kebijakan augmentasi otomatis dan augmentasi lintas sampel {.pendalaman-title .unnumbered .unlisted}
...
![Dari patch citra ke descriptor HOG](../figures/ch12-fig-2.png){#fig-ch12-fig-2}
...
![CNN pretrained sebagai feature extractor](../figures/ch12-fig-3.png){#fig-ch12-fig-3}
...
![Citra sebagai urutan patch embedding](../figures/ch12-fig-4.png){#fig-ch12-fig-4}
...
### Ekosistem ekstraktor visual pretrained {.pendalaman-title .unnumbered .unlisted}
...
![Tangga representasi audio klasik](../figures/ch12-fig-5.png){#fig-ch12-fig-5}
...
### Peta ekstraktor audio pretrained {.pendalaman-title .unnumbered .unlisted}
...
| Representasi | Modalitas | Jenis representasi | Penggunaan khas | Batas utama |
| --- | --- | --- | --- | --- |
...
| Spectrogrammel | Audio | Representasi yang dirancang manusia | Speech, mesin, environmental sound | Window, hop, dan sampling menentukan sinyal |
...
| Raw-waveform encoder embeddings | Audio | Representasi yang dipelajari mesin | Speechaudio transfer learning | Compute, domain match, pooling |

: Peta representasi citra dan audio {#tbl-ch12-8}
...
| Max pooling | Peristiwa impulsif, misalnya kaca pecah | Sensitif pada *noise* ekstrem |
...
: Strategi pooling temporal audio {#tbl-ch12-9}
