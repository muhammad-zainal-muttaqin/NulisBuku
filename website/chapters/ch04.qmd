...
![One-hot dan ordinal encoding pada kolom kategori](../figures/ch04-fig-1.png){#fig-ch04-fig-1}
...
### Nilai kosong dan kategori tak dikenal sebagai kebijakan encoder {.pendalaman-title .unnumbered .unlisted}
...
![Cross-fitting untuk target encoding](../figures/ch04-fig-2.png){#fig-ch04-fig-2}
...
### Ordered target statistics ala CatBoost {.pendalaman-title .unnumbered .unlisted}
...
![Hashing trick untuk kategori berkardinalitas tinggi](../figures/ch04-fig-3.png){#fig-ch04-fig-3}
...
### Meredam bias collision dengan alternate sign {.pendalaman-title .unnumbered .unlisted}
...
![Ruang embedding untuk kategori](../figures/ch04-fig-4.png){#fig-ch04-fig-4}
...
| Metode | Dimensi keluaran | Kardinalitas | Kategori baru | Risiko utama |
| --- | --- | --- | --- | --- |
| *One-hot* | $ \|V\| $ kolom biner | Rendah-menengah | *All-zero* infrequent bucket | Ledakan dimensi dan *sparsity*. Unknown dapat menyatu dengan referensi yang di-*drop* |
| Ordinal | 1 kolom numerik | Rendah, ordinal sejati | Kode khusus, misalnya -1 | Urutan palsu di model linearjarak |
| CountFrequency | 1 kolom numerik | Tinggi | Nilai isian terkonfigurasi | Tabrakan nilai, bukan makna semantik |
| *Target encoding* | 1 kolom numerik | Tinggi | Rata-rata global | *Target leakage* tanpa cross-fitting |
| Hashing | $ k $ kolom tetap | Sangat tinggi tak terbatas | Otomatis by construction | Collision dan hilang interpretabilitas |
| *Entity embedding* | $ d $ kolom padat | Tinggi | Indeks unknown terlatih | *Overfit* kategori langka, butuh data dan komputasi |

: Peta keputusan encoding kategorikal {#tbl-ch04-8}
