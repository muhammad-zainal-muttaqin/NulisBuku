...
![Window, cutoff, horizon, dan target pada sampel temporal](../figures/ch10-fig-1.png){#fig-ch10-fig-1}
...
| Keluarga | Menangkap apa | Contoh | Risiko utama |
| --- | --- | --- | --- |
| Lag | Nilai referensi terdekat | `cnt` jam yang sama kemarin | Dimensi dan korelasi membengkak |
| Rolling | Trenfluktuasi lokal | Rata-rata dan deviasi `cnt` 24 jam | Jendela salah skala, *target leakage* |
| Expanding | Akumulasi sejarah | Rata-rata permintaan sejak awal periode | Makna bergeser seiring panjang sejarah |
| Differencingmusiman | Perubahan, bukan level | Selisih harian, selisih mingguan | Over-differencing membuang sinyal |
| Kalendersiklik | Ritme aktivitas manusia | Jam sincos, hari libur | Periode salah |
| Frekuensi | Struktur periodik sinyal | Daya pita getaran | Butuh sampling dan jendela tepat |

: Keluarga fitur temporal {#tbl-ch10-8}
...
![Rolling window dan expanding window](../figures/ch10-fig-2.png){#fig-ch10-fig-2}
...
![Dekomposisi tren, musiman, dan residual](../figures/ch10-fig-3.png){#fig-ch10-fig-3}
...
![Sinyal sensor dalam domain waktu dan frekuensi](../figures/ch10-fig-4.png){#fig-ch10-fig-4}
...
### Discrete Fourier Transform dalam satu rumus {.pendalaman-title .unnumbered .unlisted}
...
![Temporal split dengan purge gap](../figures/ch10-fig-5.pdf){#fig-ch10-fig-5}
...
### Menentukan *purge gap* dari protokol {.pendalaman-title .unnumbered .unlisted}
...
| Aspek | Fitur eksplisit + model tabular | Model sekuensial |
| --- | --- | --- |
| Bentuk input | Kolom datar | Tensor waktu x fitur |
| Siapa menangkap pola temporal | Perancang fitur melalui lagwindowstatistik | Mekanisme internal seperti hidden state, convolution, attention |
...
: Fitur eksplisit vs input sekuensial {#tbl-ch10-9}
...
### Hibrida dan foundation model untuk deret waktu {.pendalaman-title .unnumbered .unlisted}
